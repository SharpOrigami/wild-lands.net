...
const NGPlusLoadingComponent: React.FC<NGPlusLoadingProps> = ({ isLoading, ngPlusLevel = 0 }) => {
  ...
  return (
    ...
    >
      <div className="absolute top-1/2 left-1/2 w-full max-w-sm -translate-x-1/2 -translate-y-1/2 text-center px-4">
        ...
        <div className="w-20 h-20 border-8 border-dashed border-yellow-400 border-t-transparent rounded-full animate-spin mx-auto" role="progressbar"></div>
