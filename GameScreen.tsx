    ...
    <div className={`frontier-area flex flex-col text-[var(--ink-main)] p-3 sm:p-4 md:p-5 rounded-sm ${frontierPanelShakeClass}`}>
        ...
        return (
          <div className="flex flex-col sm:flex-row items-start gap-1.5 sm:gap-2 md:gap-2 lg:gap-1.5 xl:gap-2">
            <div className="flex flex-col w-full sm:w-auto">
              ...
              <div className="flex flex-row flex-wrap justify-center w-full sm:justify-start gap-1.5 sm:gap-2 md:gap-2 lg:gap-1.5 xl:gap-2">
                <div id="activeEventCardDisplay" className="event-display-card">
                  {(() => {
                    ...
                    } else if (!(turn === 1 && objectiveChoices && objectiveChoices.length > 0)) { // Don't show All Clear during objective selection
                      return (
      ...
      <div id="playerActions" className="mt-4">
        ...
        <div className="flex gap-2 w-full mt-2">
            <button
                id="saveButton"
                className="button !bg-green-800 hover:!bg-green-900 !text-white !border-green-900 w-full"
