...
export const CHARACTERS_DATA_MAP: { [id: string]: Character } = {
    ...
    preacher: {
        ...
        talkSkill: 0.50, petSkill: 0.95,
        personality: { archetype: 'The Zealot', temperament: 'Honorable', motivation: 'Seeking Power' }
    },
    prospector: {
