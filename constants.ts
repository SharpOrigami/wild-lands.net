...
export const PERSONALITY_MODIFIERS: { [trait: string]: { talk: number; pet: number } } = {
  // Modifiers affect the base failure rate. Negative values improve the skill (reduce failure %).
  // Archetypes
  'The Stoic':      { talk: 0, pet: -1 },
  'The Idealist':   { talk: -5, pet: 5 },
  'The Pragmatist': { talk: -1, pet: 1 },
  'The Coward':     { talk: -4, pet: 4 },
  'The Zealot':     { talk: -5, pet: 3 },
  'The Mercenary':  { talk: -3, pet: 0 },
  'The Wanderer':   { talk: 0, pet: 0 },

  // Temperaments
  'Honorable':      { talk: 2, pet: -3 },
  'Deceitful':      { talk: -7, pet: 7 },
  'Reckless':       { talk: 3, pet: -2 },
  'Cautious':       { talk: 0, pet: 0 },
  'Greedy':         { talk: 3, pet: -1 },
  'Compassionate':  { talk: -5, pet: -3 },
  'Superstitious':  { talk: -4, pet: 7 },

  // Motivations
  'Seeking Redemption': { talk: 0, pet: -1 },
  'Seeking Fortune':    { talk: -4, pet: 4 },
  'Seeking Vengeance':  { talk: 0, pet: 1 },
  'Seeking Knowledge':  { talk: -5, pet: 5 },
  'Seeking Escape':     { talk: -1, pet: 0 },
  'Seeking Power':      { talk: -3, pet: 5 },
  'Seeking Peace':      { talk: -4, pet: 3 }
};
...
export const CHARACTERS_DATA_MAP: { [id: string]: Character } = {
    hunter: { 
        ...
        talkSkill: 97, petSkill: 59, // Bad talker, good petter
    ...
    trapper: { 
        ...
        talkSkill: 101, petSkill: 72, // V. bad talker, bad petter
    ...
    gunslinger: { 
        ...
        talkSkill: 94, petSkill: 66, // Bad talker, okay petter
    ...
    doctor: { 
        ...
        talkSkill: 65, petSkill: 92, // Good talker, bad petter
    ...
    explorer: { 
        ...
        talkSkill: 65, petSkill: 91, // Good talker, bad petter
    ...
    preacher: {
        ...
        talkSkill: 69, petSkill: 87, // Good talker, bad petter
    ...
    prospector: {
        ...
        talkSkill: 69, petSkill: 98, // Good talker, v. bad petter
