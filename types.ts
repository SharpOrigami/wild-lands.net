...
export interface Character {
  ...
  starterDeck: string[];
  description: string;
  talkSkill: number; // Chance to fail talking down a human threat. Lower is better.
  petSkill: number;  // Chance to fail pacifying an animal threat. Lower is better.
  personality: {
    archetype: string;
    temperament: string;
