...
const logTemplates: Record<string, Partial<Record<Theme, string[]>>> = {
  ...
  bountySold: {
    western: ["The {itemName} is paid. A hefty purse of {sellAmount}G for a job well done.", "The local law pays out {sellAmount}G for the {itemName}.", "Justice has its price. The {itemName} is cashed in for {sellAmount}G."],
    japan: ["The magistrate pays the reward of {sellAmount} mon for the head of {itemName}.", "Honor is satisfied, and so is the coin purse. {sellAmount} mon for {itemName}.", "{itemName} is collected: {sellAmount} mon."],
    safari: ["The colonial governor is pleased. The {itemName} is paid: {sellAmount} shillings.", "Another dangerous element removed.", "The contract for {itemName} pays {sellAmount} shillings.", "The bounty is collected. {sellAmount} shillings for dealing with them."],
    horror: ["The old priest pays in silver for the proof of the {itemName}. {sellAmount} pieces.", "A heavy purse of {sellAmount} silver for a dark deed. The contract on {itemName} is complete.", "The village elder pays the reward. {sellAmount} silver for a moment of peace."],
    cyberpunk: ["The fixer transfers the payment. {sellAmount} creds for the {itemName}.", "Target retired. Payment of {sellAmount} creds received for {itemName}.", "Another contract closed. {sellAmount} creds transferred for {itemName}."],
  },
  campfireBuilt: {
