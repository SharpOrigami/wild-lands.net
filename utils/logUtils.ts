...
const traitLogTemplates: {
  ...
  { trigger: 'playerAttack', condition: (p, c) => p.personality?.archetype === 'The Idealist' && c?.subType === 'human', chance: 0.5, messages: { western: ["'I do what I must, for the greater good!' He attacks the man.", "'Forgive me, but you leave me no choice!' He attacks the human.", "'This is for the good of all!' He strikes at the man."]}},
  { trigger: 'playerAttack', condition: (p, c) => p.personality?.archetype === 'The Idealist' && c?.subType === 'animal', chance: 0.5, messages: { western: ["'I'm sorry, creature, but you are a danger!' He attacks the animal.", "'This is a sad necessity.' He attacks the beast.", "'For its own good, it must be stopped.'"]}},
  { trigger: 'laudanumHeal', condition: (p) => p.personality?.archetype === 'The Idealist', chance: 0.8, messages: { western: ["'I must be strong to help others.' The laudanum restores {healAmount} HP.", "The tincture eases the pain. 'A necessary remedy to continue my work.' {healAmount} HP restored.", "He drinks, grateful for the relief. 'This will help me carry on.' {healAmount} HP restored."]}},
  ...
  { trigger: 'threatDefeated', condition: (p, c) => p.personality?.archetype === 'The Pragmatist' && c?.subType === 'human', chance: 0.6, messages: { western: ["A human obstacle removed. That's all he was.", "Problem solved. The man is neutralized.", "A predictable outcome. The human is down."]}},
  ...
  { trigger: 'playerAttack', condition: (p, c) => p.personality?.archetype === 'The Pragmatist' && c?.subType === 'human', chance: 0.5, messages: { western: ["Engaging the human threat. A necessary action.", "Neutralizing the man. It's just business.", "The most efficient solution is a direct one. He attacks the human."]}},
  { trigger: 'playerAttack', condition: (p, c) => p.personality?.archetype === 'The Pragmatist' && c?.subType === 'animal', chance: 0.5, messages: { western: ["Engaging the animal threat. A necessary action.", "Neutralizing the beast. It's just business.", "The most efficient solution is a direct one. He attacks the animal."]}},
  ...
  { trigger: 'threatDefeated', condition: (p, c) => p.personality?.archetype === 'The Coward' && c?.subType === 'human', chance: 0.8, messages: { western: ["'He's... he's not getting up? I did it!' He stares at the fallen man.", "'I'm alive! He's not!' He can't believe his luck.", "'It's over? He's really gone?'"]}},
  { trigger: 'threatDefeated', condition: (p, c) => p.personality?.archetype === 'The Coward' && c?.subType === 'animal', chance: 0.8, messages: { western: ["'It's dead! It's really dead!' He stares at the fallen {enemyName}.", "'I survived! I can't believe I survived!'", "'Is it playing dead? No, I think I got it!'"]}},
  ...
  { trigger: 'playerAttack', condition: (p, c) => p.personality?.archetype === 'The Coward' && c?.subType === 'human', chance: 0.7, messages: { western: ["A desperate swing at the man! 'Stay back! Stay back!'", "He attacks the human with his eyes closed, hoping for the best.", "'I'm sorry! Don't hurt me!' He flails wildly at the man."]}},
  { trigger: 'playerAttack', condition: (p, c) => p.personality?.archetype === 'The Coward' && c?.subType === 'animal', chance: 0.7, messages: { western: ["A desperate swing at the beast! 'Get away from me!'", "He attacks the animal with his eyes closed, praying for a miracle.", "'Aaaah!' He flails wildly at the animal."]}},
  ...
  { trigger: 'laudanumHeal', condition: (p) => p.personality?.archetype === 'The Coward', chance: 0.8, messages: { western: ["He drinks the laudanum gratefully. The pain recedes, and with it, some of the fear. {healAmount} HP restored.", "The sweet relief washes over him. 'Maybe... maybe I can survive this.' {healAmount} HP restored.", "He downs the tincture, the pain vanishing into a comforting haze. {healAmount} HP restored."]}},
  ...
  { trigger: 'playerAttack', condition: (p, c) => p.personality?.archetype === 'The Zealot' && c?.subType === 'human', chance: 0.6, messages: { western: ["'By my faith, you are struck down, sinner!'", "'Repent!' He attacks the human with righteous fury.", "'The power of my conviction compels you!' He attacks the man."]}},
  { trigger: 'playerAttack', condition: (p, c) => p.personality?.archetype === 'The Zealot' && c?.subType === 'animal', chance: 0.6, messages: { western: ["'By my faith, you are struck down, beast!'", "'Be cleansed!' He attacks the animal with righteous fury.", "'The power of my conviction compels you!' He attacks the creature."]}},
  ...
  { trigger: 'laudanumHeal', condition: (p) => p.personality?.archetype === 'The Zealot', chance: 0.8, messages: { western: ["'The body is a temple, and must be repaired to do holy work.' The laudanum restores {healAmount} HP.", "'This will grant me strength to smite the wicked.' {healAmount} HP restored.", "He drinks, feeling a surge of righteous vigor. 'The Lord's work continues!' {healAmount} HP restored."]}},
  ...
  { trigger: 'playerAttack', condition: (p, c) => p.personality?.archetype === 'The Mercenary' && c?.subType === 'human', chance: 0.6, messages: { western: ["'Nothing personal. Just a job.' He attacks the man.", "'This is gonna cost you.' He attacks the human.", "He attacks the man with cold efficiency. 'Let's get this over with.'"]}},
  { trigger: 'playerAttack', condition: (p, c) => p.personality?.archetype === 'The Mercenary' && c?.subType === 'animal', chance: 0.6, messages: { western: ["'Nothing personal. Just a job.' He attacks the beast.", "'This pelt will fetch a good price.' He attacks the animal.", "He attacks the beast with cold efficiency. 'Let's get this over with.'"]}},
  ...
  { trigger: 'laudanumHeal', condition: (p) => p.personality?.archetype === 'The Mercenary', chance: 0.8, messages: { western: ["He takes a swig. 'Can't have an injury slowing me down.' {healAmount} HP restored.", "The pain subsides. 'Good. Back in business.' {healAmount} HP restored.", "He downs the tincture. 'Time to get back to work.' {healAmount} HP restored."]}},
  ...
  { trigger: 'playerAttack', condition: (p, c) => p.personality?.archetype === 'The Wanderer' && c?.subType === 'human', chance: 0.5, messages: { western: ["A grim necessity of the road. He attacks the man.", "The journey requires this. He engages the human.", "He sighs. 'Another soul lost to the trail.' He attacks."]}},
  { trigger: 'playerAttack', condition: (p, c) => p.personality?.archetype === 'The Wanderer' && c?.subType === 'animal', chance: 0.5, messages: { western: ["A sad part of the journey. He attacks the beast.", "The wilderness can be cruel. He engages the animal.", "He moves with a heavy heart. 'Forgive me, creature.' He attacks."]}},
  ...
  { trigger: 'laudanumHeal', condition: (p) => p.personality?.archetype === 'The Wanderer', chance: 0.8, messages: { western: ["The road is hard, but its remedies are swift. The laudanum restores {healAmount} HP.", "He tends his wounds with the tincture. 'The journey continues.' {healAmount} HP restored.", "A moment of rest and repair before the next mile. {healAmount} HP restored."]}},
  ...
  // Honorable
  { trigger: 'playerAttack', condition: (p, c) => p.personality?.temperament === 'Honorable' && c?.subType === 'human', chance: 0.6, messages: { western: ["A fair fight! He attacks the man with the {itemName}.", "He meets the man head-on. 'En garde!'", "'Let this be a duel of honor!' He attacks the human threat."]}},
  { trigger: 'playerAttack', condition: (p, c) => p.personality?.temperament === 'Honorable' && c?.subType === 'animal', chance: 0.6, messages: { western: ["He gives the beast a chance to flee, but it stands its ground. He attacks.", "A clean kill is the only honorable way. He attacks the animal.", "'I take no pleasure in this, noble creature.' He attacks."]}},
  ...
  { trigger: 'threatDefeated', condition: (p, c) => p.personality?.temperament === 'Deceitful' && c?.subType === 'human', chance: 0.6, messages: { western: ["'The fool never saw it coming.' The man is dealt with.", "'Too easy.' The human is dispatched.", "He sneers at the fallen man. 'Should have watched your back.'"]}},
  { trigger: 'threatDefeated', condition: (p, c) => p.personality?.temperament === 'Deceitful' && c?.subType === 'animal', chance: 0.6, messages: { western: ["'The dumb beast never saw it coming.' The animal is dealt with.", "'Too easy.' The creature is dispatched.", "He kicks the fallen animal. 'Stupid creature.'"]}},
  ...
  { trigger: 'playerAttack', condition: (p, c) => p.personality?.temperament === 'Deceitful' && c?.subType === 'human', chance: 0.6, messages: { western: ["A strike from the shadows at the man! {attackPower} damage!", "He throws dirt in the man's eyes before attacking!", "A feint, then a stab at the human! {attackPower} damage!"]}},
  { trigger: 'playerAttack', condition: (p, c) => p.personality?.temperament === 'Deceitful' && c?.subType === 'animal', chance: 0.6, messages: { western: ["A strike from the shadows at the beast! {attackPower} damage!", "He distracts the creature before attacking!", "He attacks the beast's blind spot! {attackPower} damage!"]}},
  ...
  // Reckless
  { trigger: 'playerAttack', condition: (p, c) => p.personality?.temperament === 'Reckless' && c?.subType === 'human', chance: 0.7, messages: { western: ["'Damn the consequences!' He charges the man with the {itemName}!", "'Yeehaw!' He attacks the human with wild abandon!", "'Live or die, I'm giving this all I've got!' He charges the man."]}},
  { trigger: 'playerAttack', condition: (p, c) => p.personality?.temperament === 'Reckless' && c?.subType === 'animal', chance: 0.7, messages: { western: ["'Damn the consequences!' He charges the beast with the {itemName}!", "'Yeehaw!' He attacks the animal with wild abandon!", "'Live or die, I'm giving this all I've got!' He charges the creature."]}},
  ...
  { trigger: 'threatDefeated', condition: (p, c) => p.personality?.temperament === 'Reckless' && c?.subType === 'human', chance: 0.7, messages: { western: ["'Ha! Is that all you've got?' The man is finished.", "He spits on the ground. 'Next!' The human is no more.", "He laughs. 'That was fun! Who's next?'"]}},
  { trigger: 'threatDefeated', condition: (p, c) => p.personality?.temperament === 'Reckless' && c?.subType === 'animal', chance: 0.7, messages: { western: ["'Ha! Is that all you've got?' The beast is finished.", "He spits on the ground. 'Next!' The animal is no more.", "He laughs. 'That was fun! What's next?'"]}},
  ...
  { trigger: 'threatDefeated', condition: (p, c) => p.personality?.temperament === 'Cautious' && c?.subType === 'human', chance: 0.7, messages: { western: ["A sigh of relief. The danger posed by the man has passed.", "He checks his surroundings carefully before approaching the fallen man.", "The human threat is neutralized. He remains vigilant."]}},
  { trigger: 'threatDefeated', condition: (p, c) => p.personality?.temperament === 'Cautious' && c?.subType === 'animal', chance: 0.7, messages: { western: ["A sigh of relief. The danger posed by the beast has passed.", "He checks his surroundings carefully before approaching the fallen animal.", "The animal threat is neutralized. He remains vigilant."]}},
  { trigger: 'playerAttack', condition: (p, c) => p.personality?.temperament === 'Cautious' && c?.subType === 'human', chance: 0.5, messages: { western: ["After assessing all options, he attacks the man. 'No other choice.'", "He strikes at the human's exposed weakness.", "A carefully aimed blow at the man."]}},
  { trigger: 'playerAttack', condition: (p, c) => p.personality?.temperament === 'Cautious' && c?.subType === 'animal', chance: 0.5, messages: { western: ["After assessing all options, he attacks the beast. 'No other choice.'", "He strikes at the animal's exposed weakness.", "A carefully aimed blow at the beast."]}},
  ...
  { trigger: 'threatDefeated', condition: (p, c) => p.personality?.temperament === 'Greedy' && c?.subType === 'animal', chance: 0.7, messages: { western: ["'Should fetch a good price.' He looks over the fallen {enemyName}.", "'The pelt alone is worth the effort.' The {enemyName} is dealt with.", "'Another obstacle to my fortune removed.'"]}},
  { trigger: 'playerAttack', condition: (p, c) => p.personality?.temperament === 'Greedy' && c?.subType === 'human', chance: 0.5, messages: { western: ["'Get out of my way! There's profit to be made!' He attacks the man.", "'You're standing between me and my money!' He attacks the human.", "'Let's see what you're worth.' He attacks the man."]}},
  { trigger: 'playerAttack', condition: (p, c) => p.personality?.temperament === 'Greedy' && c?.subType === 'animal', chance: 0.5, messages: { western: ["'Get out of my way! There's profit to be made!' He attacks the beast.", "'Your pelt is worth more than your life!' He attacks the animal.", "'Let's see what you're worth.' He attacks the beast."]}},
  ...
  { trigger: 'threatDefeated', condition: (p, c) => p.personality?.temperament === 'Compassionate' && c?.subType === 'human', chance: 0.7, messages: { western: ["A necessary evil. The man will threaten no one else.", "'May you find peace.' He says a quiet word over the fallen man.", "He feels a pang of regret. 'There was no other way.'"]}},
  { trigger: 'threatDefeated', condition: (p, c) => p.personality?.temperament === 'Compassionate' && c?.subType === 'animal', chance: 0.7, messages: { western: ["A necessary evil. The beast will threaten no one else.", "'May you find peace.' He says a quiet word over the fallen animal.", "He feels a pang of regret. 'There was no other way.'"]}},
  { trigger: 'playerAttack', condition: (p, c) => p.personality?.temperament === 'Compassionate' && c?.subType === 'human', chance: 0.5, messages: { western: ["'I'm so sorry it has come to this.' He attacks the man.", "'This is for the safety of others.' He engages the human threat.", "'Please, stand down!' He attacks reluctantly."]}},
  { trigger: 'playerAttack', condition: (p, c) => p.personality?.temperament === 'Compassionate' && c?.subType === 'animal', chance: 0.5, messages: { western: ["'I'm so sorry, creature.' He attacks the beast.", "'This is for its own good, to end its suffering or its rage.'", "'Forgive me.' He attacks the animal."]}},
  ...
  { trigger: 'threatDefeated', condition: (p, c) => p.personality?.temperament === 'Superstitious' && c?.subType === 'human', chance: 0.6, messages: { western: ["'The dark spirits are banished from this man!' The {enemyName} is gone.", "He makes a sign to ward off evil over the fallen man.", "The curse is broken! The man {enemyName} is defeated."]}},
  { trigger: 'threatDefeated', condition: (p, c) => p.personality?.temperament === 'Superstitious' && c?.subType === 'animal', chance: 0.6, messages: { western: ["'The dark spirits are banished from this beast!' The {enemyName} is gone.", "He makes a sign to ward off evil over the fallen beast.", "The curse is broken! The beast {enemyName} is defeated."]}},
  { trigger: 'playerAttack', condition: (p, c) => p.personality?.temperament === 'Superstitious' && c?.subType === 'human', chance: 0.5, messages: { western: ["He mutters a prayer of protection and attacks the man.", "'Begone, foul spirit possessing this man!'", "He attacks the human, convinced he is fighting a greater evil."]}},
  { trigger: 'playerAttack', condition: (p, c) => p.personality?.temperament === 'Superstitious' && c?.subType === 'animal', chance: 0.5, messages: { western: ["He mutters a prayer of protection and attacks the beast.", "'Begone, foul spirit possessing this beast!'", "He attacks the animal, convinced he is fighting a greater evil."]}},
...
const characterLogTemplates: {
  ...
  // Hunter
  { trigger: 'playerAttack', condition: (p, c) => p.character?.id === 'hunter' && c?.id.includes('bow') && c?.subType === 'human', chance: 0.8, messages: { western: ["'A silent arrow finds its mark on the man.' {attackPower} damage to {enemyName}.", "The bowstring sings. A warning to other outlaws. {attackPower} damage.", "He nocks another arrow. 'This one's for you, varmint.'"]}},
  { trigger: 'playerAttack', condition: (p, c) => p.character?.id === 'hunter' && c?.id.includes('bow') && c?.subType === 'animal', chance: 0.8, messages: { western: ["'A silent arrow finds its mark on the beast.' {attackPower} damage to {enemyName}.", "The bowstring sings. A clean shot for a clean kill. {attackPower} damage.", "He nocks another arrow. 'A fine hunt.'"]}},
  { trigger: 'playerAttack', condition: (p, c) => p.character?.id === 'hunter' && c?.id.includes('knife') && c?.subType === 'human', chance: 0.8, messages: { western: ["'Too close for a bow. This will have to do.' He attacks the man for {attackPower} damage.", "A quick, sharp movement. The knife finds its home in the outlaw.", "He moves like a shadow, striking the man for {attackPower} damage."]}},
  { trigger: 'playerAttack', condition: (p, c) => p.character?.id === 'hunter' && c?.id.includes('knife') && c?.subType === 'animal', chance: 0.8, messages: { western: ["'Too close for a bow. A dangerous spot.' He attacks the beast for {attackPower} damage.", "A quick, sharp movement. The knife finds its home in the beast.", "He moves like a shadow, striking the animal for {attackPower} damage."]}},
  ...
  { trigger: 'playerAttack', condition: (p, c) => p.character?.id === 'trapper' && c?.id.includes('knife') && c?.subType === 'human', chance: 0.7, messages: { western: ["'Time to get my hands dirty on this fool.' {attackPower} damage to {enemyName}.", "The skinning knife is sharp enough for men too. {attackPower} damage.", "He moves with a trapper's quiet efficiency, striking the man for {attackPower} damage."]}},
  { trigger: 'playerAttack', condition: (p, c) => p.character?.id === 'trapper' && c?.id.includes('knife') && c?.subType === 'animal', chance: 0.7, messages: { western: ["'Time to get my hands dirty.' {attackPower} damage to {enemyName}.", "The skinning knife is sharp. {attackPower} damage.", "He moves with a trapper's quiet efficiency, striking the beast for {attackPower} damage."]}},
  ...
  { trigger: 'playerAttack', condition: (p, c) => p.character?.id === 'doctor' && c?.id.includes('knife') && c?.subType === 'human', chance: 0.8, messages: { western: ["'I swore an oath... but you are a sickness.' {attackPower} damage to the man.", "'This will be a precise incision.' He attacks the human.", "'Sometimes, surgery is the only answer for the wicked.' He attacks."]}},
  { trigger: 'playerAttack', condition: (p, c) => p.character?.id === 'doctor' && c?.id.includes('knife') && c?.subType === 'animal', chance: 0.8, messages: { western: ["'I swore an oath... but this beast is rabid.' {attackPower} damage to the animal.", "'This will be a precise, if regrettable, incision.' He attacks the beast.", "'Sometimes, amputation is the only answer.' He attacks the animal."]}},
  ...
  { trigger: 'playerAttack', condition: (p, c) => p.character?.id === 'herbalist' && c?.subType === 'human', chance: 0.5, messages: { western: ["'The thorns must protect the rose.' {attackPower} damage to the man.", "She strikes the man with the speed of a striking snake.", "Her attack on the man is swift and silent, like the forest itself."]}},
  { trigger: 'playerAttack', condition: (p, c) => p.character?.id === 'herbalist' && c?.subType === 'animal', chance: 0.5, messages: { western: ["'The thorns must protect the rose.' {attackPower} damage to the beast.", "She strikes the beast with the speed of a striking snake.", "Her attack on the animal is swift and silent, like the forest itself."]}},
  ...
  { trigger: 'playerAttack', condition: (p, c) => p.character?.id === 'explorer' && c?.subType === 'human', chance: 0.5, messages: { western: ["An obstacle to progress is dealt with. {attackPower} damage to the man.", "'For science!' He attacks the human threat.", "He fights the man with the fervor of a man on a mission."]}},
  { trigger: 'playerAttack', condition: (p, c) => p.character?.id === 'explorer' && c?.subType === 'animal', chance: 0.5, messages: { western: ["An obstacle to progress is dealt with. {attackPower} damage to the beast.", "'For science!' He attacks the animal threat.", "He fights the beast with the fervor of a man on a mission."]}},
  ...
  // Preacher
  { trigger: 'playerAttack', condition: (p, c) => p.character?.id === 'preacher' && c?.subType === 'human', chance: 0.7, messages: { western: ["'Smite the wicked sinner!' The {itemName} delivers {attackPower} damage unto the {enemyName}.", "'The power of faith compels you... to repent!' He attacks the man.", "'Let the Lord sort you out!' He attacks the human."]}},
  { trigger: 'playerAttack', condition: (p, c) => p.character?.id === 'preacher' && c?.subType === 'animal', chance: 0.7, messages: { western: ["'Smite the unholy beast!' The {itemName} delivers {attackPower} damage unto the {enemyName}.", "'The power of faith compels you... to be cleansed!' He attacks the animal.", "'Let the Lord sort you out!' He attacks the beast."]}},
  ...
  { trigger: 'playerAttack', condition: (p, c) => p.character?.id === 'prospector' && c?.subType === 'human', chance: 0.6, messages: { western: ["'Get off my claim, you damn claim-jumper!' {attackPower} damage to {enemyName}.", "He swings his pickaxe at the man! {attackPower} damage!", "'This here's my spot!' He attacks the man."]}},
  { trigger: 'playerAttack', condition: (p, c) => p.character?.id === 'prospector' && c?.subType === 'animal', chance: 0.6, messages: { western: ["'Get off my claim, you damn varmint!' {attackPower} damage to {enemyName}.", "He swings his pickaxe at the beast! {attackPower} damage!", "'This here's my spot!' He attacks the beast."]}},
  { trigger: 'threatDefeated', condition: (p, c) => p.character?.id === 'prospector' && c?.subType === 'human', chance: 0.6, messages: { western: ["The man {enemyName} won't be jumping his claim again.", "'Now I can get back to the real work!' The human nuisance is no longer a problem.", "He spits. 'Should have known better than to mess with a prospector's claim.'"]}},
  { trigger: 'threatDefeated', condition: (p, c) => p.character?.id === 'prospector' && c?.subType === 'animal', chance: 0.6, messages: { western: ["The beast {enemyName} won't be bothering him again.", "'Now I can get back to the real work!' The animal nuisance is no longer a problem.", "He spits. 'Should have known better than to mess with a prospector.'"]}},
...
const logTemplates: Record<string, Partial<Record<Theme, string[]>>> = {
  ...
  bountySold: {
    western: ["The bounty on {itemName} is paid. A hefty purse of {sellAmount}G for a job well done.", "The local lawman pays out {sellAmount}G for the {itemName}.", "Justice has its price. The warrant for {itemName} is cashed in for {sellAmount}G."],
