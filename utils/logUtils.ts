...
const logTemplates: Record<string, Partial<Record<Theme, string[]>>> = {
  ...
  itemBought: {
    western: ["{playerName} barters for a new {itemName}, parting with {cost} Gold.", "The {itemName} changes hands for {cost} Gold. A fine purchase.", "{playerName} parts with {cost} Gold for a much-needed {itemName}.", "A deal is struck. The {itemName} is yours for {cost} Gold.", "This {itemName} will serve me well. A worthy purchase for {cost} Gold.", "The merchant drives a hard bargain, but the {itemName} is secured for {cost} Gold.", "'This should come in handy.' {playerName} buys a {itemName} for {cost}G.", "'I'll take it.' The {itemName} costs {cost} Gold.", "The trader agrees. {itemName} acquired for {cost} Gold.", "A necessary expense. {playerName} buys a {itemName} for {cost}G."],
    japan: ["{playerName} trades for a new {itemName}, parting with {cost} mon.", "The {itemName} changes hands for {cost} mon. A fine purchase.", "{playerName} parts with {cost} mon for a much-needed {itemName}.", "A deal is struck. The {itemName} is yours for {cost} mon.", "The merchant bows as the deal is made. {itemName} acquired for {cost} mon.", "{playerName} purchases a {itemName} for {cost} mon."],
    safari: ["{playerName} barters for a new {itemName}, parting with {cost} shillings.", "The {itemName} changes hands for {cost} shillings. A fine purchase.", "{playerName} parts with {cost} shillings for a much-needed {itemName}.", "A deal is struck. The {itemName} is yours for {cost} shillings.", "After some haggling, the {itemName} is bought for {cost} shillings.", "{playerName} adds the {itemName} to their kit for {cost} shillings."],
    horror: ["{playerName} trades for a new {itemName}, parting with {cost} silver pieces.", "The {itemName} changes hands for {cost} silver pieces. A grim purchase.", "{playerName} parts with {cost} silver pieces for a much-needed {itemName}.", "A dark bargain is struck. The {itemName} is yours for {cost} silver pieces.", "The hooded figure accepts the {cost} silver pieces. The {itemName} is yours.", "A grim purchase, but necessary. {itemName} bought for {cost} silver."],
    cyberpunk: ["{playerName} acquires a new {itemName}, transferring {cost} credits.", "The {itemName} changes hands for {cost} credits. A good deal.", "{playerName} transfers {cost} credits for a much-needed {itemName}.", "Transaction complete. The {itemName} is yours for {cost} credits.", "Transferring {cost} credits. The {itemName} is acquired.", "{playerName} buys a {itemName} from a street vendor for {cost} credits."],
  },
  itemDiscarded: {
  ...
  itemEquipped: {
    western: ["{playerName} equips the {itemName}, ready for what's next.", "Gearing up. The {itemName} is now ready.", "The {itemName} is readied for the trail ahead.", "The {itemName} feels right. {playerName} equips it for the journey ahead.", "Better to be prepared. The {itemName} is equipped.", "The {itemName} is added to the loadout, ready for action.", "'This'll do nicely.' The {itemName} is equipped.", "The weight of the {itemName} is reassuring. It's now equipped.", "{playerName} holsters the {itemName}, ready for use."],
    japan: ["{playerName} dons the {itemName}, ready for what's next.", "Preparing for battle. The {itemName} is now ready.", "The {itemName} is readied for the journey ahead.", "The warrior prepares. The {itemName} is now equipped.", "Ready for battle, the {itemName} is equipped."],
    safari: ["{playerName} equips the {itemName}, ready for what's next.", "Gearing up. The {itemName} is now ready.", "The {itemName} is readied for the hunt ahead.", "The hunter readies their gear. The {itemName} is equipped.", "Preparing for the hunt. The {itemName} is equipped."],
    horror: ["{playerName} equips the {itemName}, ready for the horrors to come.", "Steeling themselves. The {itemName} is now ready.", "The {itemName} is readied for the darkness ahead.", "Steeling their resolve, {playerName} equips the {itemName}.", "The {itemName} is readied against the encroaching darkness."],
    cyberpunk: ["{playerName} installs the {itemName}, ready for what's next.", "System online. The {itemName} is now active.", "The {itemName} is integrated into the system.", "System update: {itemName} now online.", "The {itemName} is integrated into the combat suite."],
  },
  itemLeftBehind: {
  ...
  itemSold: {
    western: ["{playerName} lightens their load, selling the {itemName} for {sellAmount} Gold.", "A savvy buyer takes that {itemName} off your hands for {sellAmount} Gold.", "A good trade! The {itemName} sold for {sellAmount} cold hard cash.", "A deal's a deal. {sellAmount} Gold for the {itemName}.", "Another piece of gear turned to coin. {itemName} sold for {sellAmount}G.", "Traded the {itemName} for a hefty pouch of {sellAmount} Gold.", "The merchant grumbled but paid the {sellAmount} Gold for the {itemName}.", "Another successful transaction. {sellAmount} Gold richer.", "That {itemName} was just dead weight. Glad to get {sellAmount} Gold for it."],
    japan: ["{playerName} lightens their load, selling the {itemName} for {sellAmount} mon.", "A savvy merchant takes that {itemName} off your hands for {sellAmount} mon.", "A good trade! The {itemName} sold for {sellAmount} mon.", "The {itemName} is exchanged for {sellAmount} mon.", "{sellAmount} mon is a fair price for the {itemName}.", "The merchant agrees to the price. {sellAmount} mon for the {itemName}.", "An honorable exchange. The {itemName} brings {sellAmount} mon.", "The {itemName} is traded for coin. A wise decision."],
    safari: ["{playerName} lightens their load, selling the {itemName} for {sellAmount} shillings.", "A savvy trader takes that {itemName} off your hands for {sellAmount} shillings.", "A good trade! The {itemName} sold for {sellAmount} shillings.", "The trader agrees on {sellAmount} shillings for the {itemName}.", "The {itemName} is bartered away for {sellAmount} shillings.", "The trader inspects the {itemName} and offers {sellAmount} shillings. Deal.", "Good business. The {itemName} is sold for {sellAmount} shillings.", "The camp's quartermaster pays {sellAmount} shillings for the {itemName}."],
    horror: ["{playerName} lightens their load, selling the {itemName} for {sellAmount} silver pieces.", "A strange collector takes that {itemName} off your hands for {sellAmount} silver pieces.", "A dark bargain! The {itemName} sold for {sellAmount} silver pieces.", "The strange peddler offers {sellAmount} silver pieces for the {itemName}. The deal is done.", "Another grim transaction. The {itemName} is sold for {sellAmount} silver.", "The hooded merchant accepts the {itemName}, pressing {sellAmount} strange coins into your palm.", "A quick sale in a dimly lit stall. {sellAmount} silver for the {itemName}.", "You get rid of the {itemName} for {sellAmount} silver. Good riddance."],
    cyberpunk: ["{playerName} offloads the {itemName} for {sellAmount} credits.", "A fixer takes that {itemName} off your hands for {sellAmount} credits.", "A good deal! The {itemName} sold for {sellAmount} credits.", "Transaction complete. {itemName} offloaded for {sellAmount} credits.", "The fixer wires {sellAmount} credits for the {itemName}.", "Data-broker accepts the {itemName}. {sellAmount} credits transferred.", "Offloaded the {itemName} on the black market for {sellAmount} creds.", "A quick transaction at a street stall. {sellAmount} credits richer."],
  },
  itemStored: {
  ...
  playerAttack: {
    western: ["{playerName} attacks {enemyName} with {itemName} for {attackPower} damage.", "{playerName} unleashes hell on {enemyName} with the {itemName}, dealing {attackPower} damage.", "{playerName} presses the attack against {enemyName} with {itemName} for {attackPower} damage.", "{playerName} lets fly with the {itemName}, hitting {enemyName} for {attackPower} damage.", "A decisive strike! {itemName} deals {attackPower} damage to {enemyName}.", "'Time to dance!' {playerName} opens fire, dealing {attackPower} damage.", "A well-placed shot from the {itemName} hits for {attackPower} damage.", "{playerName} takes aim and sends {attackPower} damage downrange toward {enemyName}.", "The air cracks with the sound of the {itemName}. {enemyName} takes {attackPower} damage.", "A quick draw and a faster bullet! {attackPower} damage to the {enemyName}.", "With a roar, {playerName} charges, dealing {attackPower} damage with the {itemName}."],
    japan: ["{playerName} attacks {enemyName} with {itemName} for {attackPower} damage.", "{playerName} unleashes a flurry of blows on {enemyName} with the {itemName}, dealing {attackPower} damage.", "A swift strike with the {itemName}! {attackPower} damage to {enemyName}.", "{playerName} presses the advantage, dealing {attackPower} damage.", "A flash of steel! {attackPower} damage to the {enemyName}.", "'Iaijutsu!' {playerName}'s strike is swift and true, dealing {attackPower} damage.", "{playerName} finds an opening, the {itemName} strikes for {attackPower} damage.", "With a kiai shout, {playerName} attacks, dealing {attackPower} damage."],
    safari: ["{playerName} attacks {enemyName} with {itemName} for {attackPower} damage.", "{playerName} unleashes a devastating attack on {enemyName} with the {itemName}, dealing {attackPower} damage.", "The hunter takes their shot! {itemName} hits {enemyName} for {attackPower} damage.", "A well-placed blow with the {itemName} deals {attackPower} damage.", "The hunter strikes! {attackPower} damage to the {enemyName}.", "A clean shot from the {itemName} connects for {attackPower} damage.", "{playerName} takes down the beast, inflicting {attackPower} damage.", "The safari gun roars, dealing {attackPower} damage."],
    horror: ["{playerName} attacks {enemyName} with {itemName} for {attackPower} damage.", "{playerName} unleashes a desperate attack on {enemyName} with the {itemName}, dealing {attackPower} damage.", "A desperate blow against the darkness! {itemName} strikes for {attackPower} damage.", "{playerName} fights back the terror, dealing {attackPower} damage to {enemyName}.", "A desperate strike against the darkness! {attackPower} damage to the {enemyName}.", "'Begone, foul thing!' {playerName}'s {itemName} hits for {attackPower} damage.", "With shaking hands but a steady arm, {playerName} lands a {attackPower} damage blow.", "A prayer on their lips, {playerName} attacks for {attackPower} damage."],
    cyberpunk: ["{playerName} attacks {enemyName} with {itemName} for {attackPower} damage.", "{playerName} unleashes a hail of fire on {enemyName} with the {itemName}, dealing {attackPower} damage.", "Target acquired. {itemName} deals {attackPower} damage.", "Executing attack protocol... {attackPower} damage to {enemyName}.", "Target lock acquired. The {itemName} deals {attackPower} damage.", "Executing combat subroutine... {attackPower} damage dealt to {enemyName}.", "A burst of plasma from the {itemName} sears the target for {attackPower} damage.", "Overcharged shot connects. {attackPower} damage."],
  },
  playerCuresIllness: { 
  ...
  playerDamage: {
    western: ["{sourceName} hits {playerName} for {damageAmount} damage. Health: {currentHP}/{maxHP}.", "{playerName} takes {damageAmount} damage from {sourceName}. Now at {currentHP}/{maxHP}.", "A costly mistake. {playerName} suffers {damageAmount} damage from {sourceName}. Health is now {currentHP}/{maxHP}.", "A solid hit! {playerName} reels from {damageAmount} damage, down to {currentHP}/{maxHP}.", "{sourceName}'s attack connects, dealing {damageAmount} damage. Health is now {currentHP}/{maxHP}.", "'Damn!' {playerName} takes a hit for {damageAmount} damage. ({currentHP}/{maxHP})", "A stinging blow from {sourceName} deals {damageAmount} damage. Health: {currentHP}/{maxHP}.", "{playerName} stumbles back, taking {damageAmount} damage from the attack. ({currentHP}/{maxHP})", "The attack lands true, inflicting {damageAmount} damage on {playerName}."],
    japan: ["{sourceName} hits {playerName} for {damageAmount} damage. Health: {currentHP}/{maxHP}.", "{playerName} takes {damageAmount} damage from {sourceName}. Now at {currentHP}/{maxHP}.", "A swift blow! {playerName} takes {damageAmount} damage. Health: {currentHP}/{maxHP}.", "{sourceName} finds an opening, dealing {damageAmount} damage."],
    safari: ["{sourceName} hits {playerName} for {damageAmount} damage. Health: {currentHP}/{maxHP}.", "{playerName} takes {damageAmount} damage from {sourceName}. Now at {currentHP}/{maxHP}.", "A savage attack! {playerName} takes {damageAmount} damage. Health: {currentHP}/{maxHP}.", "{sourceName} strikes true, dealing {damageAmount} damage."],
    horror: ["{sourceName} hits {playerName} for {damageAmount} damage. Health: {currentHP}/{maxHP}.", "{playerName} takes {damageAmount} damage from {sourceName}. Now at {currentHP}/{maxHP}.", "A terrifying blow! {playerName} takes {damageAmount} damage. Health: {currentHP}/{maxHP}.", "{sourceName}'s attack rends flesh, dealing {damageAmount} damage."],
    cyberpunk: ["{sourceName} hits {playerName} for {damageAmount} damage. Health: {currentHP}/{maxHP}.", "{playerName} takes {damageAmount} damage from {sourceName}. Now at {currentHP}/{maxHP}.", "Armor breach! {playerName} takes {damageAmount} damage. Integrity: {currentHP}/{maxHP}.", "{sourceName}'s attack finds a weak point, dealing {damageAmount} damage."],
  },
  playerDeckFinalized: { 
  ...
  playerHeal: { 
    western: ["{playerName} patches themself up with {sourceName}, restoring {healAmount} HP. Now at {currentHP}/{maxHP}.", "Using the {sourceName} restores {healAmount} HP. Back in the fight at {currentHP}/{maxHP}.", "A moment of respite. The {sourceName} restores {healAmount} health, bringing them to {currentHP}/{maxHP}.", "That's better. {healAmount} HP recovered thanks to {sourceName}.", "A quick application of {sourceName} mends the wound. Healed {healAmount} HP.", "The {sourceName} works its magic. {playerName} feels stronger, gaining {healAmount} health.", "Downing the {sourceName} brings welcome relief. Recovered {healAmount} HP.", "A moment to tend to injuries with {sourceName}. {healAmount} health restored.", "'This oughta do it.' {playerName} uses {sourceName} and recovers {healAmount} HP."],
    japan: ["{playerName} tends to their wounds with {sourceName}, restoring {healAmount} HP. Now at {currentHP}/{maxHP}.", "Using the {sourceName} restores {healAmount} HP. Back in the fight at {currentHP}/{maxHP}.", "The {sourceName} mends the body and spirit. {healAmount} health restored. Now at {currentHP}/{maxHP}.", "Ki is restored. {healAmount} HP recovered.", "A moment of focus and the {sourceName} restores {healAmount} ki.", "The herbal remedy soothes the wound, healing {healAmount} HP.", "The pain subsides. {healAmount} health recovered.", "With a deep breath, {playerName} applies the {sourceName}, gaining {healAmount} health."],
    safari: ["{playerName} patches themself up with {sourceName}, restoring {healAmount} HP. Now at {currentHP}/{maxHP}.", "Using the {sourceName} restores {healAmount} HP. Back in the fight at {currentHP}/{maxHP}.", "The medicine works. {healAmount} HP recovered, now at {currentHP}/{maxHP}.", "A moment to patch up. The {sourceName} restores {healAmount} health.", "The field dressing is applied. {healAmount} HP restored.", "A dose of quinine and water helps. {playerName} recovers {healAmount} health.", "The safari doctor's poultice works wonders. Healed {healAmount} HP.", "A moment's rest and the {sourceName} does its work. {healAmount} HP gained."],
    horror: ["{playerName} patches themself up with {sourceName}, restoring {healAmount} HP. Now at {currentHP}/{maxHP}.", "Using the {sourceName} restores {healAmount} HP. Back in the fight at {currentHP}/{maxHP}.", "A brief reprieve from the pain. {sourceName} restores {healAmount} HP. Now at {currentHP}/{maxHP}.", "The poultice soothes the wound. {healAmount} HP recovered.", "The strange poultice stings, but it works. Healed {healAmount} HP.", "A moment of prayer and a bit of {sourceName} restores {healAmount} health.", "The pain recedes into a dull ache. {healAmount} HP recovered.", "The blessed balm closes the wound. {healAmount} health gained."],
    cyberpunk: ["{playerName} patches themself up with {sourceName}, restoring {healAmount} HP. Now at {currentHP}/{maxHP}.", "Using the {sourceName} restores {healAmount} HP. Back in the fight at {currentHP}/{maxHP}.", "Nanites at work. {sourceName} repairs {healAmount} HP. System at {currentHP}/{maxHP}.", "System integrity restored by {healAmount}. Now at {currentHP}/{maxHP}.", "Nanites activate, repairing {healAmount} damage. System at {currentHP}/{maxHP}.", "The med-stim injects, restoring {healAmount} HP.", "Bio-foam seals the wound. {healAmount} health recovered.", "A quick system reboot and a dose of {sourceName} brings {playerName} back by {healAmount} HP."],
  },
  ...
  threatDefeated: { 
    western: ["The {enemyName} has been defeated by {playerName}.", "The {enemyName} falls before {playerName}. The wilderness is a little less crowded.", "Another threat neutralized. The {enemyName} is no more.", "{playerName} stands victorious over the fallen {enemyName}.", "The {enemyName} breathes its last. The trail is safer now.", "With a final blow, {playerName} puts an end to the {enemyName}.", "Another one bites the dust. The {enemyName} is down for the count."],
    japan: ["The {enemyName} has been defeated by {playerName}.", "The {enemyName} has been vanquished.", "{playerName} has proven their skill against the {enemyName}."],
    safari: ["The {enemyName} has been defeated by {playerName}.", "The hunt is successful. The {enemyName} is down.", "Another dangerous beast is dealt with. The {enemyName} is defeated."],
    horror: ["The {enemyName} has been defeated by {playerName}.", "The nightmare is ended. The {enemyName} is destroyed.", "One less horror to haunt the night. The {enemyName} has been slain."],
    cyberpunk: ["The {enemyName} has been defeated by {playerName}.", "Target neutralized. The {enemyName} unit is offline.", "{playerName} decommissions the {enemyName}."],
  },
  threatDefeatedHigh: {
